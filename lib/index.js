...
module.exports = function (script, scriptArgs, nodeArgs, opts) {
  ...
  var startDelay = parseInt(opts.startdelay, 10)
  var restartDelay = parseInt(opts.restartdelay, 10)

  function notifyOfRestart(modifiedFile) {
    var relativeFile = path.relative('', modifiedFile)
    notify('Restarting', relativeFile + ' has been modified');
  }
  ...
  // Start the child after an initial delay
